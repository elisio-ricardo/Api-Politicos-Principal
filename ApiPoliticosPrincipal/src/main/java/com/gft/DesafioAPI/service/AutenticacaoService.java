...
import com.gft.DesafioAPI.dto.auth.AutenticacaoDTO;
import com.gft.DesafioAPI.dto.auth.TokenDTO;
...
public class AutenticacaoService {
    ...
    @Value("${politico.jwt.secret}")
    private String secret;

    @Value("${politico.jwt.expiration}")
    private String expiration;

    @Value("${politico.jwt.issuer}")
